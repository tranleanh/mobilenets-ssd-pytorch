...
class VOCDataset:
    ...
    def __init__(self, root, transform=None, target_transform=None, is_test=False, keep_difficult=False, label_file=None):
        ...
        if is_test:
            ...
            image_sets_file = "./data/VOCdevkit/test/VOC2007/ImageSets/Main/test.txt"
        else:
            # image_sets_file = self.root / "ImageSets/Main/trainval.txt"

            # image_sets_file = self.root + "VOC2007/ImageSets/Main/trainval.txt"
            image_sets_file = "./data/VOCdevkit/VOC2007/ImageSets/Main/trainval.txt"
    ...
    def _get_annotation(self, image_id):
        ...
        try:
            annotation_file = "./data/VOCdevkit/VOC2007/" + f"Annotations/{image_id}.xml"
            ...
            annotation_file = "./data/VOCdevkit/test/VOC2007/" + f"Annotations/{image_id}.xml"
